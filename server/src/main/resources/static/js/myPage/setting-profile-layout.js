...
function createThumbnail(file) {
    ...
    text += `</li>`;
    document.querySelector(".FeelogBox-root.flog-div-29").innerHTML = text;
    document.querySelector(".FeelogBox-root.flog-div-29").scrollIntoView({ behavior: "smooth", block: "start" });   // 추가된 행들이 처지지 않게 위치 잡아주기

}

// 2025.04.21  조승찬 :: 모달창으로 정보 전달
function provideInform(){
