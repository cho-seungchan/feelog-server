    ...
    const showList = async (postListData) => {
        ...
        postListData.postList.forEach((post)=>{
            ...
            text = `
                ...
                <div class="MuiStack-root joy-11dfn0q">
                    ...
                    <div class="MuiStack-root joy-1ka30t1">
                        <div class="MuiStack-root joy-j7qwjs">
                            <a class="MuiLink-root MuiLink-colorPrimary MuiLink-body-md MuiLink-underlineNone joy-151y3tr" href="/@pampa234/post/18985410"><h2 class="MuiTypography-root MuiTypography-h4 joy-63nzw0">
                                    ${post.postTitle}
                                </h2></a>
                        </div>
