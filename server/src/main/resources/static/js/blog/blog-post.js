document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderPostCards(posts) {
        ...
        posts.forEach(p => {
            ...
            // Null 체크와 빈 값 체크
            const profilePath = (p.memberProfilePath && p.memberProfilePath.trim() !== '' && p.memberProfilePath !== 'null' && p.memberProfilePath !== 'undefined')
                ? p.memberProfilePath
                : null;

            const profileName = (p.memberProfileName && p.memberProfileName.trim() !== '' && p.memberProfileName !== 'null' && p.memberProfileName !== 'undefined')
                ? p.memberProfileName
                : null;
...
<<<<<<< HEAD
                                <a class="FlgStack-root-need jk-feelog-a-006" href="/feelog.com/@${p.memberNickname}">
=======
                                <a class="FlgStack-root-need jk-feelog-a-006" href="/feelog.com/@${p.channelUrl}">
>>>>>>> 78be3dd36f29f8c14032d059321c89ef5aa0d754
...
<<<<<<< HEAD
                                <a class="FlgBox-root-need jk-feelog-a-008" href="/feelog.com/${p.channelUrl}">
=======
                                <a class="FlgBox-root-need jk-feelog-a-008" href="/feelog.com/@${p.channelUrl}">
>>>>>>> 78be3dd36f29f8c14032d059321c89ef5aa0d754
