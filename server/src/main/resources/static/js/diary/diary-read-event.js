diaryService.getRandomDiaryList(diaryLayout.showRandomDiary);
replyService.getReplyList(diaryLayout.showReplyList);
...
if (writeReplyButton) {
    writeReplyButton.addEventListener("click", async (e) => {
        ...
        await replyService.getReplyList(diaryLayout.showReplyList);
    })
}
...
replyContainer.addEventListener("click", async (e) => {
    if (e.target.closest(".like_button")) {
        ...
        await replyService.insertDiaryReplyLike({
